...
escrever_xyz(OUTPUT_STRUCTURE_FILE, n_replications_x * n_replications_y * n_atoms, comment, replicated_atoms)

print('Estrutura replicada com sucesso! arquivo salvo em {}'.format(OUTPUT_STRUCTURE_FILE))
